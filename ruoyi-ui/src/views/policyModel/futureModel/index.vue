    ...
    <div class="table">
      ...
      <el-form :inline="true" :model="formAdd" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button
            type="success"
            @click="exportFutureModel"
            v-hasPermi="['policyModel:futureModel:export']"
            >导出预测模型</el-button
          >
        </el-form-item>
      </el-form>
      ...
      >
        ...
        <el-table-column label="模型材料数量" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              v-hasPermi="['policyModel:futureModel:edit']"
              >查看信息</el-button
            >
          </template>
        </el-table-column>
        ...
        <el-table-column align="center" min-width="100px">
          ...
          <template slot-scope="scope">
            <el-button size="mini" @click="lookup(scope.row)"
              >编辑模型</el-button
            >
            <el-button size="mini" @click="check(scope.$index)"
              >匹配企业</el-button
            >
            <el-button
              size="mini"
              type="success"
              @click="exportSingleModel(scope.row)"
              v-hasPermi="['policyModel:futureModel:export']"
              >导出</el-button
            >
          </template>
        ...
        <el-table-column align="center">
          ...
          <template slot-scope="scope">
            <el-button size="mini" @click="handleUpdateModel(scope.row)"
              >修改基本属性</el-button
            >
            <el-button size="mini" type="danger" @click="delModel(scope.row)"
              >删除</el-button
            >
          </template>
        </el-table-column>
        ...
        <div class="btn">
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleAdd()"
              v-hasPermi="['system:companyProperty:add']"
              >新增</el-button
            >
          </el-col>
        </div>
            ...
            >
              <template slot-scope="scope">
                <el-button
                  ...
                  v-hasPermi="['system:DocDetail:edit']"
                  >修改</el-button
                >
                <el-button
                  size="mini"
                  ...
                  v-hasPermi="['system:DocDetail:remove']"
                  >删除</el-button
                >
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      if (!matchingItem) {
        ...
        if (
          ...
          this.$message.error("数据项和阈值类型不匹配");
        }
      }
    },
    lookup(row) {
    ...
    hasDuplicateOptions(str) {
      const options = str.split(";").filter((option) => option.trim() !== "");
    ...
    exportFutureModel() {
      this.$confirm("是否确认导出预测模型数据?", "警告", {
        ...
        .then(() => {
          ...
          return download(
            "/system/policyContent/exportFutureModel",
            {},
            "预测模型数据.xlsx"
          );
        })
    ...
    exportSingleModel(row) {
      this.$confirm("是否确认导出该预测模型数据?", "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
      ...
      <el-form :inline="true" :model="formAdd" class="demo-form-inline">
        <el-form-item>
          <el-button
            type="primary"
            @click="modelAdd"
            v-hasPermi="['futureModel:policyModel:add']"
            >新增模型</el-button
          >
          <el-button
            type="success"
      ...
      >
        ...
        <el-table-column label="模型材料数量" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              type="text"
              @click="handleDocNumber(scope)"
              v-hasPermi="['futureModel:docList:list']"
              >查看信息</el-button
            >
          </template>
        </el-table-column>
        ...
        <el-table-column align="center" min-width="100">
          ...
          <template slot-scope="scope">
            <el-button
              size="mini"
              v-hasPermi="['futureModel:policyModelDetail:list']"
...
<!--            >-->
        ...
        <el-table-column align="center">
          ...
          <template slot-scope="scope">
            <el-button
              size="mini"
              v-hasPermi="['futureModel:policyContent:edit']"
            ...
            <el-button
              size="mini"
              type="danger"
              v-hasPermi="['futureModel:policyModel:remove']"
      ...
      <el-dialog :visible.sync="dialogFormVisibleAdd">
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button
            type="primary"
            v-hasPermi="[
              'futureModel:policyModel:add',
              'futureModel:policyContent:edit',
            ]"
            ...
            <el-table-column fixed="right" label="操作" align="center">
              <template slot-scope="scope">
                <el-button
                  size="mini"
                  type="danger"
                  v-hasPermi="['futureModel:policyModelIndicator:remove']"
                  @click="handleDeletePolicyModel(scope.row)"
                  >删除</el-button
                >
                <el-button
                  size="mini"
                  type="primary"
                  v-hasPermi="['futureModel:policyModelIndicator:edit']"
                  @click="handleUpdatePolicyModel(scope.$index)"
                  >修改</el-button
                >
              </template>
        ...
        <div class="formula" style="margin-top: 20px">
          <div style="margin-bottom: 10px">
            ...
            <el-button
              ...
              size="mini"
              @click="handleUpdateFormula"
              v-hasPermi="['futureModel:policyModelFormula:edit']"
              >更新</el-button
            >
            <el-button type="primary" @click="open" size="mini">提示</el-button>
          </div>
        ...
        <div class="info">
          ...
          >
            ...
            <el-form-item>
              <el-button
                type="primary"
                v-hasPermi="['futureModel:policyModelSimple:add']"
                @click="onSubmit"
                >立即创建</el-button
              >
              <el-button @click="handleCloseAdd">取消</el-button>
          ...
          >
            ...
            <el-form-item>
              <el-button
                type="primary"
                v-hasPermi="['futureModel:policyModelComplex:add']"
      ...
      >
        <el-col :span="1.5">
          <el-button
            ...
            @click="handleDocDetailAdd()"
            style="position: absolute; top: 1.8vh; left: 6vw"
            v-hasPermi="['futureModel:policyModelDocDetail:edit']"
            >新增</el-button
          >
        </el-col>
        <div class="info">
      ...
      rules: {
        name: [
          { required: true, message: "请输入政策模型名称", trigger: "blur" },
          {
            ...
            //   const reg = new RegExp("^" + year);
            //   if (!reg.test(value)) {
            //     callback("政策模型名称必须以大于" + year + "的年份开头");
            //   } else {
            //     callback();
            //   }
            // },
            validator: (rule, value, callback) => {
              ...
              if (!match) {
                return callback(new Error("政策模型名称必须以年份开头"));
              }

              const inputYear = parseInt(match[0], 10);
              const currentYear = new Date().getFullYear();

              if (inputYear <= currentYear) {
                return callback(
                  new Error(`政策模型名称的年份必须大于${currentYear}`)
                );
              }
